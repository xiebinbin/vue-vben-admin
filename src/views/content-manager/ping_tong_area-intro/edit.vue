...
<script lang="ts">
  ...
  const pageTitle = ref<string>('平通区域简介');
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      onMounted(async () => {
        ...
        methods.setFieldsValue({
          intro: keyVals['ping_tong_area-intro'] ?? '',
        });
        formData.intro = keyVals['ping_tong_area-intro'] ?? '';
      });
      return {
        schemas,
        handleReset,
